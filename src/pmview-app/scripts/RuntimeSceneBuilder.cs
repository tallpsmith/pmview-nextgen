...
public static class RuntimeSceneBuilder
{
    ...
    {
        // No controller script — the outer HostViewController.gd handles wiring
        // for the runtime path. The host_view_controller.gd addon script is only
        // for standalone .tscn files generated by HostProjector.
        return new Node3D { Name = "HostView" };
    }
